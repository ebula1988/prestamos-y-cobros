                      ...
                      <div class="row boxasd">
                        <div class="col-md-12">
                          ...
                          <div class="col-md-1">
                            <div class="radio">
                            <label>
                              <input type="radio" name="optionsRadios" onclick="cargarTotal()" id="optionsRadios1" value="option1" checked>
                              Hoy
                            </label>
                          </div>
                          </div>
              ...
              <div class="col-md-12">
                  <div class="box">
                    ...
                    <div class="box-header with-border">
                          <button class="btn btn-success" id="btnagregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar prestamo</button>

                          <?php 
                            if ( $_SESSION['nivel_adm'] == 0 ){
                              echo '<button class="btn btn-danger" id="btnagregar" onclick="abrirFrmCliente()"><i class="fa fa-plus-circle"></i> Cliente Nuevo</button>';
                            }
                          ?>
